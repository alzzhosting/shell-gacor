...
for app in $(cmd package list packages -3 | cut -f 2 -d ":"); do
    if [[ "$app" != "me.piebridge.brevent" && "$app" != "com.draco.ladb" && "$app" != "com.ddm.qute" && "$app" != "com.levv.gametuner" && "$app" != "com.levv.magictweak" ]]; then
        ...
        if [[ $? -ne 0 ]]; then
            #Tweak Cadangan
            cmd device_config put game_overlay "$app" mode=2,fps=120,useAngle=true,scaling=disable,downscale=disable,downscaleFactor=disable,resolutionScaling=disable,upscale=disable,upscaleFactor=disable:mode=3,fps=120,useAngle=false,scaling=disable,downscale=disable,downscaleFactor=disable,resolutionScaling=disable,upscale=disable,upscaleFactor=disable > /dev/null 2>&1
        ...
        # Tweak Downscale & fps
        cmd game set --mode 2 --fps 120 --downscale disable --upscale disable --user 2000 "$app"; cmd game set --mode 3 --fps 120 --downscale disable --user 2000 "$app" > /dev/null 2>&1
        cmd game list-modes "$app" > /dev/null 2>&1
        if [[ $? -ne 0 ]]; then
            #Tweak Cadangan
            cmd device_config put game_overlay "$app" mode=2,fps=120,useAngle=true,scaling=disable,downscale=disable,downscaleFactor=disable,resolutionScaling=disable,upscale=disable,upscaleFactor=disable:mode=3,fps=120,useAngle=false,scaling=disable,downscale=disable,downscaleFactor=disable,resolutionScaling=disable,upscale=disable,upscaleFactor=disable > /dev/null 2>&1
        ...
        # Tweak Downscale & fps
        cmd game set --mode 2 --fps 120 --downscale disable --upscale disable --user $USER_ID "$app"; cmd game set --mode 3 --fps 120 --downscale disable --user $USER_ID "$app" > /dev/null 2>&1
        cmd game list-modes "$app" > /dev/null 2>&1
        if [[ $? -ne 0 ]]; then
            #Tweak Cadangan
            cmd device_config put game_overlay "$app" mode=2,fps=120,useAngle=true,scaling=disable,downscale=disable,downscaleFactor=disable,resolutionScaling=disable,upscale=disable,upscaleFactor=disable:mode=3,fps=120,useAngle=false,scaling=disable,downscale=disable,downscaleFactor=disable,resolutionScaling=disable,upscale=disable,upscaleFactor=disable > /dev/null 2>&1
...
system_settings=(
  ...
  "game_default_frame_rate_override 120"
  "enable_frame_rate_override 1"
  "virtual_display_default_refresh_rate 120"
  "force_max_refresh_rate 120"
  "override_min_frame_rate 120"
  "use_content_detection_for_refresh_rate 0"
  "default_fps 120"
  "disable_idle_fps 1"
  "fps.limit.is.now locked"
  "aod_monitor_default_fps 120"
  "fod_monitor_default_fps 120"
  "app_switch_fps 120"
  "low_power_fps 120"
  "gaming_mode_fps 120"
  "battery_saving_mode_fps 120"
  "idle_reduce_framerate_enable no"
  "idle_default_fps 120"
  "enable_dpps_dynamic_fps 0"
  "enable_perf_hint_for_low_fps 1"
  "low_framerate_limit 120"
  "refresh_rate 120"
  "default_refresh_rate 120"
  "last_tran_refresh_mode_in_refresh_setting 120"
  "min_refresh_rate 120"
  "max_refresh_rate 120"
  "refresh_default_rate 120"
  "thermal_limit_refresh_rate 120"
  "user_refresh_rate 120"
  "peak_refresh_rate 120"
  "pointer_speed 7"
  "power_save_refresh_rate 120"
  ...
  "power_saving_fps_limit 120"
  "miui_home_animation_rate 3"
  "adaptive_refresh_rate 0"
  "aod_monitor_default_fps 120"
  "enforce_refresh_rate 120"
  "game_max_fps 120"
  "game_min_fps 120"
  "gaming_mode_fps 120"
  "input_refresh_rate 120"
  "input_sampling_rate 120"
  "low_framerate_limit 120"
  "refresh_rate 120"
  ...
  "game_driver_fps_limit 120"
  "game_driver_frame_skip_enable 0"
  "game_driver_gpu_mode 1"
  "game_driver_max_frame_rate 120"
  "game_driver_min_frame_rate 120"
  "game_driver_power_saving_mode 0"
  "game_driver_vsync_enable 1"
  "gaming_mode_fps 120"
  "high_fps_mode 4"
  "minimum_refresh_rate 120"
  "sem_power_mode_refresh_rate 0,0,-1,0,2"
  "sem_power_mode_refresh_rate_cover 0,0,-1,0,2"
  "vendor_display_refresh_rate 120"
  "fps_current_limit 120"
  "NV_FPSLIMIT 120"
  "high_frame_rate_sf_set_big_core_fps_threshold 0"
  "frame_rate_multiple_threshold 0"
  "scroll_boost_refreshrate 120"
  "touch_boost_refreshrate 120"
  "user_screen_refresh_rate 120"
  "game_scene_more_fps 120"
  "miui_refresh_rate 120"
  "maximum_refresh_rate 120"
  "SpeedControlPara ver_num=3;enable=false;thermal=99;limit_level=120,120,120,120;limit_level_up=120,120,120,120;prohibittimer=7200"
  "power_save_pre_refresh_state 120"
...
global_settings=(
  ...
  "tran_refresh_rate_video_detector_support 1"
  "tran_need_recovery_refresh_mode 120"
  "preferred_display_refresh_rate 120"
  "refresh_rate 120"
  ...
  "ScreenRefreshRateController_resultFps 120"
  "double_frame_flag 0"
  "drop_frame_flag 0"
...
settings put system game_default_frame_rate_override 120
settings put system enable_frame_rate_override 1
settings put system virtual_display_default_refresh_rate 120
settings put system force_max_refresh_rate 120
settings put system override_min_frame_rate 120
settings put system use_content_detection_for_refresh_rate 0
settings put system default_fps 120
settings put system disable_idle_fps 1
settings put system fps.limit.is.now locked
settings put system aod_monitor_default_fps 120
settings put system fod_monitor_default_fps 120
settings put system app_switch_fps 120
settings put system low_power_fps 120
settings put system gaming_mode_fps 120
settings put system battery_saving_mode_fps 120
settings put system idle_reduce_framerate_enable no
settings put system idle_default_fps 120
settings put system enable_dpps_dynamic_fps 0
settings put system enable_perf_hint_for_low_fps 1
settings put system low_framerate_limit 120
...
settings put system power_save_refresh_rate 120
...
settings put system power_saving_fps_limit 120
settings put system miui_home_animation_rate 3
settings put system adaptive_refresh_rate 0
settings put system aod_monitor_default_fps 120
settings put system enforce_refresh_rate 120
settings put system game_max_fps 120
settings put system game_min_fps 120
settings put system gaming_mode_fps 120
settings put system input_refresh_rate 120
settings put system input_sampling_rate 120
settings put system low_framerate_limit 120
settings put system refresh_rate 120
settings put system refresh_rate_adaptive 0
settings put system refresh_rate_limit 120
...
settings put system vendor_display_refresh_rate 120
...
settings put system scroll_boost_refreshrate 120
settings put system touch_boost_refreshrate 120
settings put system user_screen_refresh_rate 120
settings put system game_scene_more_fps 120
settings put system miui_refresh_rate 120
settings put system maximum_refresh_rate 120
settings put system SpeedControlPara ver_num=3;enable=false;thermal=99;limit_level=120,120,120,120;limit_level_up=120,120,120,120;prohibittimer=7200
settings put system power_save_pre_refresh_state 120
...
settings put global low_power_fps 120
...
settings put global tran_need_recovery_refresh_mode 120
settings put global preferred_display_refresh_rate 120
...
android_properties=(
  "debug.renderengine.target_fps 120"
  ...
  "debug.hwui.fpslimit 120"
  "debug.hwui.fps_limit 120"
  ...
  "debug.refresh_rate.peak_fps 120"
  "debug.hwc.dynamic_refresh_rate false"
  "debug.hwc.lock_refresh_rate true"
  "debug.hwc.refresh_rate 120"
  "debug.sf.120_fps.hwc.min.duration 50000"
  "debug.sf.prim_perf_120hz_base_brightness_zone 120:120:120,120:120:120"
  "debug.sf.prim_perf_120hz_base_brightness_zone 120:120:120,120:120:120,120:120:120"
  "debug.sf.prim_std_brightness_zone 120:120:120,120:120:120"
  "debug.sf.cli_perf_brightness_zone 120:120:120"
  "debug.sf.cli_std_brightness_zone 120:120:120"
  ...
  "debug.sf.120_fps.late.sf.duration 50000"
  "debug.sf.120_fps.late.app.duration 50000"
  "debug.sf.120_fps.early.sf.duration 50000"
  "debug.sf.120_fps.early.app.duration 50000"
  "debug.sf.120_fps.earlyGl.sf.duration 50000"
  "debug.sf.120_fps.earlyGl.app.duration 50000"
...
android_properties() {
setprop debug.renderengine.target_fps 120
...
setprop debug.sf.120_fps.late.sf.duration 50000
setprop debug.sf.120_fps.late.app.duration 50000
setprop debug.sf.120_fps.early.sf.duration 50000
setprop debug.sf.120_fps.early.app.duration 50000
setprop debug.sf.120_fps.earlyGl.sf.duration 50000
setprop debug.sf.120_fps.earlyGl.app.duration 50000
