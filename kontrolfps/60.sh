...
for app in $(cmd package list packages -3 | cut -f 2 -d ":"); do
    if [[ "$app" != "me.piebridge.brevent" && "$app" != "com.draco.ladb" && "$app" != "com.ddm.qute" && "$app" != "com.levv.gametuner" && "$app" != "com.levv.magictweak" ]]; then
        ...
        if [[ $? -ne 0 ]]; then
            #Tweak Cadangan
            cmd device_config put game_overlay "$app" mode=2,fps=60,useAngle=true,scaling=disable,downscale=disable,downscaleFactor=disable,resolutionScaling=disable,upscale=disable,upscaleFactor=disable:mode=3,fps=60,useAngle=false,scaling=disable,downscale=disable,downscaleFactor=disable,resolutionScaling=disable,upscale=disable,upscaleFactor=disable > /dev/null 2>&1
        ...
        # Tweak Downscale & fps
        cmd game set --mode 2 --fps 60 --downscale disable --upscale disable --user 2000 "$app"; cmd game set --mode 3 --fps 60 --downscale disable --user 2000 "$app" > /dev/null 2>&1
        cmd game list-modes "$app" > /dev/null 2>&1
        if [[ $? -ne 0 ]]; then
            #Tweak Cadangan
            cmd device_config put game_overlay "$app" mode=2,fps=60,useAngle=true,scaling=disable,downscale=disable,downscaleFactor=disable,resolutionScaling=disable,upscale=disable,upscaleFactor=disable:mode=3,fps=60,useAngle=false,scaling=disable,downscale=disable,downscaleFactor=disable,resolutionScaling=disable,upscale=disable,upscaleFactor=disable > /dev/null 2>&1
        ...
        # Tweak Downscale & fps
        cmd game set --mode 2 --fps 60 --downscale disable --upscale disable --user $USER_ID "$app"; cmd game set --mode 3 --fps 60 --downscale disable --user $USER_ID "$app" > /dev/null 2>&1
        cmd game list-modes "$app" > /dev/null 2>&1
        if [[ $? -ne 0 ]]; then
            #Tweak Cadangan
            cmd device_config put game_overlay "$app" mode=2,fps=60,useAngle=true,scaling=disable,downscale=disable,downscaleFactor=disable,resolutionScaling=disable,upscale=disable,upscaleFactor=disable:mode=3,fps=60,useAngle=false,scaling=disable,downscale=disable,downscaleFactor=disable,resolutionScaling=disable,upscale=disable,upscaleFactor=disable > /dev/null 2>&1
...
system_settings=(
  ...
  "game_default_frame_rate_override 60"
  "enable_frame_rate_override 1"
  "virtual_display_default_refresh_rate 60"
  "force_max_refresh_rate 60"
  "override_min_frame_rate 60"
  "use_content_detection_for_refresh_rate 0"
  "default_fps 60"
  "disable_idle_fps 1"
  "fps.limit.is.now locked"
  "aod_monitor_default_fps 60"
  "fod_monitor_default_fps 60"
  "app_switch_fps 60"
  "low_power_fps 60"
  "gaming_mode_fps 60"
  "battery_saving_mode_fps 60"
  "idle_reduce_framerate_enable no"
  "idle_default_fps 60"
  "enable_dpps_dynamic_fps 0"
  "enable_perf_hint_for_low_fps 1"
  "low_framerate_limit 60"
  "refresh_rate 60"
  "default_refresh_rate 60"
  "last_tran_refresh_mode_in_refresh_setting 60"
  "min_refresh_rate 60"
  "max_refresh_rate 60"
  "refresh_default_rate 60"
  "thermal_limit_refresh_rate 60"
  "user_refresh_rate 60"
  "peak_refresh_rate 60"
  "pointer_speed 7"
  "power_save_refresh_rate 60"
  ...
  "table_framerate 60"
  "touch_sampling_rate 60"
  "touch_response_rate 1"
  "touch_sampling_rate 60"
  "touch_sampling_rate_override 0"
  "game_driver_fps_limit 60"
  "game_driver_frame_skip_enable 0"
  "game_driver_gpu_mode 1"
  "game_driver_max_frame_rate 60"
  "game_driver_min_frame_rate 60"
  ...
  "vendor_display_refresh_rate 60"
  "fps_current_limit 60"
  "NV_FPSLIMIT 60"
  "high_frame_rate_sf_set_big_core_fps_threshold 0"
  "frame_rate_multiple_threshold 0"
  "scroll_boost_refreshrate 60"
  "touch_boost_refreshrate 60"
  "user_screen_refresh_rate 60"
  "game_scene_more_fps 60"
  "miui_refresh_rate 60"
  "maximum_refresh_rate 60"
  "SpeedControlPara ver_num=3;enable=false;thermal=99;limit_level=60,60,60,60;limit_level_up=60,60,60,60;prohibittimer=7200"
  "power_save_pre_refresh_state 60"
...
global_settings=(
  ...
  "tran_refresh_rate_video_detector_support 1"
  "tran_need_recovery_refresh_mode 60"
  "preferred_display_refresh_rate 60"
  "refresh_rate 60"
  ...
  "vivo_screen_refresh_rate_mode 60"
  "FPSTUNER_SWITCH false"
  "ScreenRefreshRateController_resultFps 60"
  "double_frame_flag 0"
  "drop_frame_flag 0"
...
settings put system game_default_frame_rate_override 60
settings put system enable_frame_rate_override 1
settings put system virtual_display_default_refresh_rate 60
settings put system force_max_refresh_rate 60
settings put system override_min_frame_rate 60
settings put system use_content_detection_for_refresh_rate 0
settings put system default_fps 60
settings put system disable_idle_fps 1
settings put system fps.limit.is.now locked
settings put system aod_monitor_default_fps 60
settings put system fod_monitor_default_fps 60
settings put system app_switch_fps 60
settings put system low_power_fps 60
settings put system gaming_mode_fps 60
settings put system battery_saving_mode_fps 60
settings put system idle_reduce_framerate_enable no
settings put system idle_default_fps 60
settings put system enable_dpps_dynamic_fps 0
settings put system enable_perf_hint_for_low_fps 1
settings put system low_framerate_limit 60
settings put system refresh_rate 60
...
settings put system tran_low_battery_60hz_refresh_rate_support 1
settings put system tran_90hz_refresh_rate_not_support 1
settings put system tran_120hz_refresh_rate_not_support 0
settings put system tran_60hz_refresh_rate_not_support 0
...
settings put system power_saving_fps_limit 60
settings put system miui_home_animation_rate 3
settings put system adaptive_refresh_rate 0
settings put system aod_monitor_default_fps 60
settings put system enforce_refresh_rate 60
settings put system game_max_fps 60
settings put system game_min_fps 60
settings put system gaming_mode_fps 60
settings put system input_refresh_rate 60
settings put system input_sampling_rate 60
settings put system low_framerate_limit 60
settings put system refresh_rate 60
settings put system refresh_rate_adaptive 0
settings put system refresh_rate_limit 60
settings put system refresh_rate_locked 1
settings put system table_framerate 60
...
settings put system minimum_refresh_rate 60
settings put system sem_power_mode_refresh_rate 0,0,-1,0,2
settings put system sem_power_mode_refresh_rate_cover 0,0,-1,0,2
settings put system vendor_display_refresh_rate 60
settings put system fps_current_limit 60
...
settings put system scroll_boost_refreshrate 60
settings put system touch_boost_refreshrate 60
settings put system user_screen_refresh_rate 60
settings put system game_scene_more_fps 60
settings put system miui_refresh_rate 60
settings put system maximum_refresh_rate 60
settings put system SpeedControlPara ver_num=3;enable=false;thermal=99;limit_level=60,60,60,60;limit_level_up=60,60,60,60;prohibittimer=7200
settings put system power_save_pre_refresh_state 60
...
settings put global low_power_fps 60
...
settings put global tran_low_battery_60hz_refresh_rate_support 1
settings put global tran_90hz_refresh_rate_not_support 1
settings put global tran_120hz_refresh_rate_not_support 0
settings put global tran_60hz_refresh_rate_not_support 0
...
settings put global tran_need_recovery_refresh_mode 60
settings put global preferred_display_refresh_rate 60
...
settings put global vivo_screen_refresh_rate_mode 60
settings put global FPSTUNER_SWITCH false
settings put global ScreenRefreshRateController_resultFps 60
...
android_properties=(
  "debug.renderengine.target_fps 60"
  ...
  "debug.egl.hw 1"
  "debug.hwc.force_gpu_vsync true"
  "debug.hwui.force_no_vsync false"
  "debug.hwui.skip_vsync false"
  ...
  "debug.redroid.fps 60"
  "debug.perf_event_max_sample_rate 240"
  "debug.hwui.fps_divisor 0"
  "debug.hwui.profile.maxframes 60"
  "debug.hwui.fpslimit 60"
  "debug.hwui.fps_limit 60"
  "debug.OVRPlugin.systemDisplayFrequency 60"
  "debug.mediatek.high_frame_rate_sf_set_big_core_fps_threshold 0"
  "debug.refresh_rate.min_fps 60"
  "debug.refresh_rate.max_fps 60"
  "debug.refresh_rate.peak_fps 60"
  "debug.hwc.dynamic_refresh_rate false"
  "debug.hwc.lock_refresh_rate true"
  "debug.hwc.refresh_rate 60"
  "debug.sf.60_fps.hwc.min.duration 50000"
  "debug.sf.prim_perf_60hz_base_brightness_zone 60:60:60,60:60:60"
  "debug.sf.prim_perf_60hz_base_brightness_zone 60:60:60,60:60:60,60:60:60"
  "debug.sf.prim_std_brightness_zone 60:60:60,60:60:60"
  "debug.sf.cli_perf_brightness_zone 60:60:60"
  "debug.sf.cli_std_brightness_zone 60:60:60"
  "debug.sf.scroll_boost_refreshrate 60"
  "debug.sf.touch_boost_refreshrate 60"
  ...
  "debug.sf.60_fps.late.sf.duration 50000"
  "debug.sf.60_fps.late.app.duration 50000"
  "debug.sf.60_fps.early.sf.duration 50000"
  "debug.sf.60_fps.early.app.duration 50000"
  "debug.sf.60_fps.earlyGl.sf.duration 50000"
  "debug.sf.60_fps.earlyGl.app.duration 50000"
...
android_properties() {
setprop debug.renderengine.target_fps 60
...
setprop debug.OVRPlugin.systemDisplayFrequency 60
...
setprop debug.hwc.refresh_rate 60
setprop debug.sf.60_fps.hwc.min.duration 50000
setprop debug.sf.prim_perf_60hz_base_brightness_zone 60:60:60,60:60:60
setprop debug.sf.prim_perf_60hz_base_brightness_zone 60:60:60,60:60:60,60:60:60
setprop debug.sf.prim_std_brightness_zone 60:60:60,60:60:60
setprop debug.sf.cli_perf_brightness_zone 60:60:60
setprop debug.sf.cli_std_brightness_zone 60:60:60
...
setprop debug.sf.60_fps.late.sf.duration 50000
setprop debug.sf.60_fps.late.app.duration 50000
setprop debug.sf.60_fps.early.sf.duration 50000
setprop debug.sf.60_fps.early.app.duration 50000
setprop debug.sf.60_fps.earlyGl.sf.duration 50000
setprop debug.sf.60_fps.earlyGl.app.duration 50000
