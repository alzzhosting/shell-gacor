...
for app in $(cmd package list packages -3 | cut -f 2 -d ":"); do
    if [[ "$app" != "me.piebridge.brevent" && "$app" != "com.draco.ladb" && "$app" != "com.ddm.qute" && "$app" != "com.levv.gametuner" && "$app" != "com.levv.magictweak" ]]; then
        ...
        if [[ $? -ne 0 ]]; then
            #Tweak Cadangan
            cmd device_config put game_overlay "$app" mode=2,fps=144,useAngle=true,scaling=disable,downscale=disable,downscaleFactor=disable,resolutionScaling=disable,upscale=disable,upscaleFactor=disable:mode=3,fps=144,useAngle=false,scaling=disable,downscale=disable,downscaleFactor=disable,resolutionScaling=disable,upscale=disable,upscaleFactor=disable > /dev/null 2>&1
        ...
        # Tweak Downscale & fps
        cmd game set --mode 2 --fps 144 --downscale disable --upscale disable --user 2000 "$app"; cmd game set --mode 3 --fps 144 --downscale disable --user 2000 "$app" > /dev/null 2>&1
        cmd game list-modes "$app" > /dev/null 2>&1
        if [[ $? -ne 0 ]]; then
            #Tweak Cadangan
            cmd device_config put game_overlay "$app" mode=2,fps=144,useAngle=true,scaling=disable,downscale=disable,downscaleFactor=disable,resolutionScaling=disable,upscale=disable,upscaleFactor=disable:mode=3,fps=144,useAngle=false,scaling=disable,downscale=disable,downscaleFactor=disable,resolutionScaling=disable,upscale=disable,upscaleFactor=disable > /dev/null 2>&1
        ...
        # Tweak Downscale & fps
        cmd game set --mode 2 --fps 144 --downscale disable --upscale disable --user $USER_ID "$app"; cmd game set --mode 3 --fps 144 --downscale disable --user $USER_ID "$app" > /dev/null 2>&1
        cmd game list-modes "$app" > /dev/null 2>&1
        if [[ $? -ne 0 ]]; then
            #Tweak Cadangan
            cmd device_config put game_overlay "$app" mode=2,fps=144,useAngle=true,scaling=disable,downscale=disable,downscaleFactor=disable,resolutionScaling=disable,upscale=disable,upscaleFactor=disable:mode=3,fps=144,useAngle=false,scaling=disable,downscale=disable,downscaleFactor=disable,resolutionScaling=disable,upscale=disable,upscaleFactor=disable > /dev/null 2>&1
...
system_settings=(
  ...
  "SpeedControlPara ver_num=3;enable=false;thermal=99;limit_level=144,144,144,144;limit_level_up=144,144,144,144;prohibittimer=7200"
...
global_settings=(
  ...
  "ScreenRefreshRateController_resultFps 144"
  "double_frame_flag 0"
  "drop_frame_flag 0"
...
settings put system SpeedControlPara ver_num=3;enable=false;thermal=99;limit_level=144,144,144,144;limit_level_up=144,144,144,144;prohibittimer=7200
...
settings put global ScreenRefreshRateController_resultFps 144
...
android_properties=(
  "debug.renderengine.target_fps 144"
  ...
  "debug.redroid.fps 144"
  "debug.perf_event_max_sample_rate 240"
  "debug.hwui.fps_divisor 0"
  "debug.hwui.profile.maxframes 144"
  "debug.hwui.fpslimit 144"
  "debug.hwui.fps_limit 144"
  "debug.OVRPlugin.systemDisplayFrequency 144"
  "debug.mediatek.high_frame_rate_sf_set_big_core_fps_threshold 0"
  "debug.refresh_rate.min_fps 144"
  "debug.refresh_rate.max_fps 144"
  "debug.refresh_rate.peak_fps 144"
  "debug.hwc.dynamic_refresh_rate false"
  "debug.hwc.lock_refresh_rate true"
  "debug.hwc.refresh_rate 144"
  "debug.sf.144_fps.hwc.min.duration 50000"
  "debug.sf.prim_perf_144hz_base_brightness_zone 144:144:144,144:144:144"
  "debug.sf.prim_perf_144hz_base_brightness_zone 144:144:144,144:144:144,144:144:144"
  "debug.sf.prim_std_brightness_zone 144:144:144,144:144:144"
  "debug.sf.cli_perf_brightness_zone 144:144:144"
  "debug.sf.cli_std_brightness_zone 144:144:144"
  "debug.sf.scroll_boost_refreshrate 144"
  "debug.sf.touch_boost_refreshrate 144"
  ...
  "debug.sf.144_fps.late.sf.duration 50000"
  "debug.sf.144_fps.late.app.duration 50000"
  "debug.sf.144_fps.early.sf.duration 50000"
  "debug.sf.144_fps.early.app.duration 50000"
  "debug.sf.144_fps.earlyGl.sf.duration 50000"
  "debug.sf.144_fps.earlyGl.app.duration 50000"
...
android_properties() {
setprop debug.renderengine.target_fps 144
...
setprop debug.hwui.fpslimit 144
setprop debug.hwui.fps_limit 144
setprop debug.OVRPlugin.systemDisplayFrequency 144
setprop debug.mediatek.high_frame_rate_sf_set_big_core_fps_threshold 0
setprop debug.refresh_rate.min_fps 144
setprop debug.refresh_rate.max_fps 144
setprop debug.refresh_rate.peak_fps 144
setprop debug.hwc.dynamic_refresh_rate false
setprop debug.hwc.lock_refresh_rate true
setprop debug.hwc.refresh_rate 144
setprop debug.sf.144_fps.hwc.min.duration 50000
setprop debug.sf.prim_perf_144hz_base_brightness_zone 144:144:144,144:144:144
setprop debug.sf.prim_perf_144hz_base_brightness_zone 144:144:144,144:144:144,144:144:144
setprop debug.sf.prim_std_brightness_zone 144:144:144,144:144:144
setprop debug.sf.cli_perf_brightness_zone 144:144:144
setprop debug.sf.cli_std_brightness_zone 144:144:144
setprop debug.sf.scroll_boost_refreshrate 144
setprop debug.sf.touch_boost_refreshrate 144
...
setprop debug.sf.144_fps.late.sf.duration 50000
setprop debug.sf.144_fps.late.app.duration 50000
setprop debug.sf.144_fps.early.sf.duration 50000
setprop debug.sf.144_fps.early.app.duration 50000
setprop debug.sf.144_fps.earlyGl.sf.duration 50000
setprop debug.sf.144_fps.earlyGl.app.duration 50000
